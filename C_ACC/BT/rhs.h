...
void compute_rhs()
{
  ...
  //---------------------------------------------------------------------
  #pragma acc parallel loop seq//#pragma acc parallel loop private(i,j,k,m,rho_inv)
  ...
  #pragma acc parallel loop seq//#pragma acc parallel loop private(i,j,k,m,uijk,up1,um1) 
  ...
  #pragma acc parallel loop seq//#pragma acc parallel loop private(i,j,k,m,vijk,vp1,vm1) 
  for (k = 1; k <= grid_points[2]-2; k++) {
    //#pragma acc loop
    for (j = 1; j <= grid_points[1]-2; j++) {
      //#pragma acc loop
  ...
  #pragma acc parallel loop seq//#pragma acc parallel loop private(k,j,i,m,wijk,wp1,wm1) 
  for (k = 1; k <= grid_points[2]-2; k++) {
    //#pragma acc loop
    for (j = 1; j <= grid_points[1]-2; j++) {
      //#pragma acc loop
  ...
  //---------------------------------------------------------------------
  k = 1;
  #pragma acc parallel loop seq//#pragma acc parallel loop private(i,j,m)
  for (j = 1; j <= grid_points[1]-2; j++) {
    //#pragma acc loop
    for (i = 1; i <= grid_points[0]-2; i++) {
      for (m = 0; m < 5; m++) {
