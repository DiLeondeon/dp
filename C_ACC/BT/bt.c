...
//delete(rhs,ce,grid_points,u,forcing,rho_i,us,vs,ws,qs,square,fjac,njac,lhs)
  ...
  #pragma acc exit data copyout(u[0:KMAX][0:JMAXP+1][0:IMAXP+1][0:5],rhs[0:KMAX][0:JMAXP+1][0:IMAXP+1][5],forcing[0:KMAX][0:JMAXP+1][0:IMAXP+1][0:5]) delete(rhs,ce,grid_points,u,forcing,rho_i,us,vs,ws,qs,square,fjac,njac,lhs)
